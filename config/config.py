...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://sensen34:sensen34@cluster0.cwymv12.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID","-1003093852581"))

# A name for your Music bot.

MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME","cemal")

# Your User ID.

OWNER_ID = list(

    map(int, getenv("OWNER_ID", "7913960724").split())
